...
domains = read_domain("./domain_list_kazakhstan.txt")
servers = ["Control_Server_IP1", "Control_Server_IP2", "Control_Server_IP3", "Control_Server_IP4", "Control_Server_IP5", "Control_Server_IP6","Control_Server_IP7", "Control_Server_IP8", "Control_Server_IP9", "Control_Server_IP10",   "Control_Server_IP11",   "Control_Server_IP12"]
timeout = 5
...
with open("20230217-application-traceroute-kazakhstan-94.131.2.86-attempt1.json", "w") as f:
