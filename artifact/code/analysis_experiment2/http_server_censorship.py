...
with open('/Volumes/Macintosh/Users/crystal/disguiser/server/2022-10-30_http_proxyrack_censorship_attempt4.json', 'r') as f:
    line = f.readline()
    country_count = {}
    suspicious_vps = {}
    ...
    while line is not None and line != '':
        ...
        with open('/domain_title_dict_2021.txt') as file:
            for entry in file:
        ...
        title = False
        for domain in data['domain']:
            # data['domain'][domain].pop("Server_IP")           
            for url in url_list:
                vp_response = data['domain'][domain][url]['text']
        ...
        for domain in suspicious_vps['domain'].copy():
            ...
            for i in range(12):
                ...
                if suspicious_vps['domain'][domain][url_list[i]] == "detect censorship":
                    Delete = False
