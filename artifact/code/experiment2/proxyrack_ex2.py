...
def local_cache_test(proxy):
    ...
    cache_http_result = proxy_http(domain, "server_IP", proxy=proxy, timeout=5)
    # cache failure, drop proxy
    ...
    #         has_cache = True
        ...
        test_http_result = proxy_http(domain, "server_IP", proxy=proxy, timeout=5)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        url_list = ["Control_Server_IP1", "Control_Server_IP2", "Control_Server_IP3", "Control_Server_IP4", "Control_Server_IP5", "Control_Server_IP6","Control_Server_IP7", "Control_Server_IP8", "Control_Server_IP9", "Control_Server_IP10",   "Control_Server_IP11",   "Control_Server_IP12"]
        ...
        for http_result in data:
            ...
            results = joblib.Parallel(n_jobs = 10,  backend="threading") (joblib.delayed(proxy_http) (item[0], item[1], proxy=proxy) for item in list)
